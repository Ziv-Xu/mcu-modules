...
const char font_sample[] = "你好世界";

/*
 *中文字符字模库，需自己取模，【阴码  逐行式  顺向（高位在前）16*16 十六进制】
 *取完后直接复制粘贴到下面，内部不要加中括号。只定义了一个一维数组。
 *再添加完字模后，在把字加到上面的font_sample里面，不用加标点，直接加上去，如“你好世界我”
 */
const unsigned char chinese_font[] = {
