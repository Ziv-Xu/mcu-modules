...
extern SoftI2C_Obj i2c_oled;

// I2C函数名宏定义映射（适配soft_i2c的函数名）
#define Soft_I2C_Start()     SoftI2C_Start(&i2c_oled)
#define Soft_I2C_SendByte(d) SoftI2C_SendByte(&i2c_oled, (d))
#define Soft_I2C_WaitAck()   SoftI2C_WaitAck(&i2c_oled)
#define Soft_I2C_Stop()      SoftI2C_Stop(&i2c_oled)
