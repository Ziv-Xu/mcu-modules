...
extern "C"
{
    ...
    {
        BUTTON_EVENT_NONE       = 0,
        BUTTON_EVENT_PRESSED    = 1, /* 按键按下（消抖确认） */
        BUTTON_EVENT_RELEASED   = 2, /* 按键释放 */
        BUTTON_EVENT_LONG_PRESS = 3, /* 长按（可配置时间） */
        BUTTON_EVENT_CLICK      = 4  /* 点击（可扩展双击等） */
    } ButtonEvent_t;
